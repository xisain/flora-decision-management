...
@section('content')
    <div class="mx-auto px-4 py-6">
        ...
        <form action="{{ route('tim-explorasi.store') }}" method="POST" enctype="multipart/form-data" x-data="{
            anggota: [{ collector_id: '', nama: '', peran: '' }],
            ...
            {{-- Error dari Laravel (old input aware) --}}
                ...
                <div class="px-6 py-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="lokasi_explorasi" id="lokasi_explorasi"
                                value="{{ old('lokasi_explorasi') }}" placeholder="Masukan Lokasi Explorasi"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_explorasi" id="deskripsi_explorasi" rows="4" placeholder="Masukan Deskripsi Explorasi"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-(--flora-moss) focus:border-transparent transition @error('deskripsi_explorasi') border-red-400 @enderror">{{ old('deskripsi_explorasi') }}</textarea>
