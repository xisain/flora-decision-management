...
@section('content')
    <div class="px-4 py-6 mx-auto">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            {{-- Form --}}
            <form action="{{ route('collector.store') }}" method="POST" class="px-6 py-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            id="initial_collector_name"
                            name="initial_collector_name"
                            value="{{ old('initial_collector_name') }}"
                            placeholder="contoh: BST"
                            maxlength="3"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-800
                                   placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[var(--flora-moss)]
