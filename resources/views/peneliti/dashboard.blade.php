        ...
        <div class="mx-auto space-y-6 px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="space-y-3">
                        @foreach ($tasks as $task)
                            <div class="flex items-center justify-between gap-4 rounded-xl border px-4 py-3 {{ $task['class'] }}">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="space-y-4">
                        @forelse ($rankingTanaman ?? [] as $index => $ranking)
                            <div>
                                <div class="mb-1.5 flex items-center justify-between gap-3">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-slate-700">
                                            {{ $ranking->nama_tanaman ?? 'Tanaman' }}
                                        </span>
                                    </div>

                                    <span class="text-xs text-slate-400">
                                        Net Flow {{ $ranking->net_flow ?? 0 }}
                                    </span>
                                </div>

                                <div class="h-2 overflow-hidden rounded-full bg-slate-100">
                                    <div class="h-full rounded-full bg-emerald-500"
                                        style="width: {{ min(100, (($ranking->net_flow ?? 0) * 100)) }}%">
                                    </div>
                                </div>
                            </div>
                        @empty
